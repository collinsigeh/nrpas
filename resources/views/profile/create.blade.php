    ...
    <div class="row">
        ...
        <form action="{{ route('profile.store') }}" method="post" class="mt-4 small-form">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <input type="text" name="middlename" placeholder="MIDDLE NAME" value="{{ old('middlename') }}" class="form-control" required>
                </div>
                <div class="col-md-6 mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    <input type="text" name="middlename" placeholder="ADDRESS (Enter Apartment, suite, or Unit)" value="{{ old('middlename') }}" class="form-control" required>
                </div>
                <div class="col-md-6 mb-4">
            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    <input type="text" name="org_name" placeholder="ORGANIZATION NAME" value="{{ old('org_name') }}" class="form-control" required>
                </div>
                <div class="col-md-12 mb-4">
                    <input type="text" name="rcc_no" placeholder="DBA (RCC NUMBER)" value="{{ old('rcc_no') }}" class="form-control" required>
                </div>
            </div>
