    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div id="page">
                    <h1 class="my-custom-title">Fly For Fun</h1>
                    <hr>
                    <h5>Before you fly outside you must:</h5>
                    <ul>
                        <li>
                    ...
                    <hr>
                    <h5>To Register, You'll Need:</h5>
                    <ul>
                        <li>
                            Valid Email address
                        </li>
                        <li>
                            Credit / Debit card or any other acceptable means of payment (if payment is required)
                        </li>
                        <li>
                    ...
                    <hr>
                    <h1 class="my-custom-title">Fly For Work/Business</h1>
                    <hr>
                    <p>Below are the basic things an operator must know for flying under the RPA regulation (Nig.CAR part 21):</p>
                    <hr>
                    <h4>Pilot Requirements:</h4>
                    <ul>
                        <li>
